...
export function ResultsCard({ ratings, officials, onRestart }: ResultsCardProps) {
  ...
  return (
    <div id="results-card" className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 py-8">
  ...
  <div className="bg-white rounded-2xl shadow-xl overflow-hidden border">
    ...
    >
      {/* Background */}
      <div className="relative w-full bg-gradient-to-br from-green-600 via-green-700 to-green-800 rounded-2xl">
        {/* Decorative circles */}
        <div className="absolute top-0 right-0 w-32 h-32 md:w-64 md:h-64 bg-white opacity-10 rounded-full translate-x-1/3 -translate-y-1/3"></div>
        <div className="absolute bottom-0 left-0 w-24 h-24 md:w-52 md:h-52 bg-white opacity-10 rounded-full -translate-x-1/3 translate-y-1/3"></div>
        <div className="absolute top-1/2 left-1/2 w-20 h-20 md:w-40 md:h-40 bg-white opacity-5 rounded-full -translate-x-1/2 -translate-y-1/2"></div>

        {/* Content */}
        <div className="relative z-10 px-4 py-8 sm:px-8 md:px-12 md:py-12 flex flex-col gap-8">
          {/* Header */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="bg-white text-green-700 text-sm sm:text-base px-4 py-2 rounded-lg font-semibold">
              2025 Report
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
            ...
            <div className="flex-1">
              ...
              <p className="text-green-100 text-lg sm:text-xl mb-6">After 2+ years in office</p>

              <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-2xl px-6 py-8 inline-block">
                <div className="text-center">
                  <div className="text-6xl sm:text-7xl md:text-8xl font-bold text-white mb-4 leading-none">
                  ...
                  <p className="text-white text-xl font-semibold mb-1">{getRatingLabel(averageRating)}</p>
                  <p className="text-green-100 text-sm sm:text-base">{totalRatings} officials rated</p>
                </div>
              </div>
            </div>
            ...
            {/* Right - Officials */}
            <div className="flex-1">
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl px-6 py-8">
                <h3 className="text-white text-xl sm:text-2xl font-bold mb-6">Top Rated Officials</h3>
                      ...
                      return (
                        <div key={official.id} className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-white font-medium text-base sm:text-lg">{official.name}</p>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-white font-bold text-base sm:text-lg">{rating}/5</span>
                          </div>
                        </div>
                      );
                    })}
          ...
          {/* Footer */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-green-100 gap-2 text-sm sm:text-base">
            <p>Generated on {new Date().toLocaleDateString()} • #RateYourLeaders</p>
            <p className="font-medium">ratedem.vercel.app</p>
          </div>
        </div>
      </div>
    </div>
